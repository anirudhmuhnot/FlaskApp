...
import numpy as np
import base64
img_name = '/Users/anirudhmuhnot/Google Drive/github/FlaskApp/static/damage_categories.png'
...
def get_prediction(content):
    ...
    learn = load_learner('/Users/anirudhmuhnot/Google Drive/github/FlaskApp/apps/data/vehicle_damage')
...
def parse_contents(contents, filename, m):
    ...
    with open("/Users/anirudhmuhnot/Google Drive/github/FlaskApp/apps/data/vehicle_damage/test/" + filename, "wb") as f:
        f.write(data)
    r,out,idx = get_prediction(str('/Users/anirudhmuhnot/Google Drive/github/FlaskApp/apps/data/vehicle_damage/test/'+filename))
